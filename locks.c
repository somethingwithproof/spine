...
static const char *get_name (int lock)
{
	...
	case LOCK_PHP_PROC_9:
		return "php_proc_9";
	case LOCK_PHP_PROC_10:
		return "php_proc_10";
	case LOCK_PHP_PROC_11:
		return "php_proc_11";
	case LOCK_PHP_PROC_12:
		return "php_proc_12";
	case LOCK_PHP_PROC_13:
		return "php_proc_13";
	case LOCK_PHP_PROC_14:
		return "php_proc_14";
	case LOCK_THDET:
		return "thdet";
	case LOCK_HOST_TIME:
...
pthread_cond_t *get_cond (int lock)
{
	...
	case LOCK_PHP:
		...
		break;
	case LOCK_PHP_PROC_0:
		ret_val = &php_proc_0_cond;
		break;
	case LOCK_PHP_PROC_1:
		ret_val = &php_proc_1_cond;
		break;
	case LOCK_PHP_PROC_2:
		ret_val = &php_proc_2_cond;
		break;
	case LOCK_PHP_PROC_3:
		ret_val = &php_proc_3_cond;
		break;
	case LOCK_PHP_PROC_4:
		ret_val = &php_proc_4_cond;
		break;
	case LOCK_PHP_PROC_5:
		ret_val = &php_proc_5_cond;
		break;
	case LOCK_PHP_PROC_6:
		ret_val = &php_proc_6_cond;
		break;
	case LOCK_PHP_PROC_7:
		ret_val = &php_proc_7_cond;
		break;
	case LOCK_PHP_PROC_8:
		ret_val = &php_proc_8_cond;
		break;
	case LOCK_PHP_PROC_9:
		ret_val = &php_proc_9_cond;
		break;
	case LOCK_PHP_PROC_10:
		ret_val = &php_proc_10_cond;
		break;
	case LOCK_PHP_PROC_11:
		ret_val = &php_proc_11_cond;
		break;
	case LOCK_PHP_PROC_12:
		ret_val = &php_proc_12_cond;
		break;
	case LOCK_PHP_PROC_13:
		ret_val = &php_proc_13_cond;
		break;
	case LOCK_PHP_PROC_14:
		ret_val = &php_proc_14_cond;
		break;
	case LOCK_THDET:
		ret_val = &thdet_cond;
		break;
	case LOCK_HOST_TIME:
		ret_val = &host_time_cond;
		break;
	}
...
pthread_mutex_t *get_lock (int lock)
{
	...
	case LOCK_PHP_PROC_9:
		...
		break;
	case LOCK_PHP_PROC_10:
		ret_val = &php_proc_10_lock;
		break;
	case LOCK_PHP_PROC_11:
		ret_val = &php_proc_11_lock;
		break;
	case LOCK_PHP_PROC_12:
		ret_val = &php_proc_12_lock;
		break;
	case LOCK_PHP_PROC_13:
		ret_val = &php_proc_13_lock;
		break;
	case LOCK_PHP_PROC_14:
		ret_val = &php_proc_14_lock;
		break;
	case LOCK_THDET:
		ret_val = &thdet_lock;
		break;
	case LOCK_HOST_TIME:
		ret_val = &host_time_lock;
		break;
	}
...
pthread_once_t *get_attr (int locko)
{
	...
	case LOCK_PHP_PROC_9_O:
		...
		break;
	case LOCK_PHP_PROC_10_O:
		ret_val = &php_proc_10_lock_o;
		break;
	case LOCK_PHP_PROC_11_O:
		ret_val = &php_proc_11_lock_o;
		break;
	case LOCK_PHP_PROC_12_O:
		ret_val = &php_proc_12_lock_o;
		break;
	case LOCK_PHP_PROC_13_O:
		ret_val = &php_proc_13_lock_o;
		break;
	case LOCK_PHP_PROC_14_O:
		ret_val = &php_proc_14_lock_o;
		break;
	case LOCK_THDET_O:
		ret_val = &thdet_lock_o;
		break;
	case LOCK_HOST_TIME_O:
		ret_val = &host_time_lock_o;
		break;
	}
