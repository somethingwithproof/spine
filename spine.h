...
/* Logging macros using C11 variadic macro support.
 * Conditional variants use short-circuit evaluation to skip
 * the spine_log() call when verbosity is below the threshold.
 */
